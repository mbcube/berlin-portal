          ...
          <main>
            ...
            {/* <li className="nav-item">
                    ...
                    <li className="nav-item dropdown dropdown-xl no-caret">
                      ...
                      <div
                        className="dropdown-menu dropdown-menu-end me-lg-n20 me-xl-n15 animated--fade-in-up"
                    ...
                    <div className="col-xl-8 col-lg-10 text-center">
                      <div data-aos="fade-up">
                        ...
                        <p className="page-header-ui-text">
                          ...
                          specialised teachers, work contracts and opportunities
                          for work in Germany.
                        </p>
                      </div>
                    </div>
              ...
              <div className="container px-5">
                <div className="row gx-5 text-center">
                  ...
                  <div className="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <h2>Study</h2>
                    <p className="mb-0">
                      Finish your studies in Germany and start building your
                      idea future.
                    </p>
                  </div>
                  <div className="col-lg-4">
                    ...
                    <h2>Work</h2>
                    <p className="mb-0">
                      Relocate to Germany for work and experience life in a
                      first world country.
                    </p>
                  </div>
                </div>
            ...
            <section className="bg-light py-10">
              <div className="container px-5">
                <div className="row gx-5 brands text-gray-500 align-items-center mb-5">
                  ...
                  {/*<div className="col-6 col-sm-4 col-lg-2 d-flex justify-content-center mb-5 mb-lg-0">
                    <svg
                      id="Layer_1"
                      data-name="Layer 1"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="col-6 col-sm-4 col-lg-2 d-flex justify-content-center mb-5 mb-sm-0">
                    <svg
                      id="Layer_1"
                      data-name="Layer 1"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="col-lg-8" data-aos="fade-up">
                    <div className="card lift mb-n15">
                      <div className="card-body p-2 pb-1">
                        ...
                        ></iframe>
                        {/* <div
                          className="video overlay bg-img-cover rounded"
                          style={{
                            backgroundImage:
                              "url('https://source.unsplash.com/wD1LRb9OeEo/1500x900')",
                          }}
                        >
                          <a
